...
public abstract class BaseGameActivity extends Cocos2dxActivity implements
	...
	static BaseGameActivity activity;
	...
	/**
	 * Sets the requested clients. The preferred way to set the requested clients is via the constructor, but this method is available if for some reason your code cannot do this in the constructor. This must be called before onCreate in order to have any effect. If called after onCreate, this method is a no-op.
	 * 
	 * @param requestedClients
	...
	protected void setUnknownErrorMessage(String signingInMessage) {
		mHelper.setUnknownErrorMessage(signingInMessage);
	}

	public void onMainMenuStarted() {
		mHelper.setup(this, mRequestedClients);
		mHelper.mGamesClient.connect();
	}
	...
	public void updateLeaderboard(int data) {
		mHelper.mGamesClient.submitScore("CgkIn4u4qPYdEAIQAQ", data);
	}

	public void openLeaderBoard() {
		startActivityForResult(mHelper.mGamesClient.getLeaderboardIntent("CgkIn4u4qPYdEAIQAQ"), 1);
	}

	public void openAchievementBoard() {
		startActivityForResult(mHelper.mGamesClient.getAchievementsIntent(), 1);
	}

	public void unlockAchievement(int current) {
		String id = "";
		switch (current) {
		case 0:
			id = "CgkIn4u4qPYdEAIQAg";
			break;
		case 1:
			id = "CgkIn4u4qPYdEAIQAw";
			break;
		case 2:
			id = "CgkIn4u4qPYdEAIQBA";
			break;
		case 3:
			id = "CgkIn4u4qPYdEAIQBQ";
			break;
		case 4:
			id = "CgkIn4u4qPYdEAIQBg";
			break;
		}

		mHelper.mGamesClient.unlockAchievement(id);
	}
